...
2. Never create or modify any .md (Markdown) files
3. Never create any .example.yml files
4. Never create or modify README files of any kind
5. Never create or modify shell script files (.sh, .bash, or similar)
6. Never create or modify test files (unit tests, integration tests, or any testing-related files)
7. Generate a comprehensive Git commit message in English that documents all changes made
...
- .md files, .example.yml files, README files, shell scripts, and test files must be completely excluded from any modifications during the pipeline execution
